...
#define HORARIO_PONTA 		0
#define HORARIO_FORA_PONTA 	1
#define HORARIO_RESERVADO   2
#define HORARIO_NULO   		3
...
extern void RTCSetTimeFromEpoch(unsigned int time);
extern RTCTime RTCGetTime( void );
extern unsigned long long DateToTimestamp(RTCTime,int);
extern void RTCSetAlarm( RTCTime );
extern void RTCSetAlarmMask( DWORD AlarmMask );
extern char GETtipoDeHorario(void);
extern void Releportempo(void);
extern void Releportempo2(void);

extern short BuscaNovoMinimo(long int MinimoAtual);
extern short RTCtoDataHora( RTCTime Tempo );
extern void RTCtoMesDiaHoraMin(short *MesDia, short *HoraMin);
extern void TesteBateria(void);
#endif /* end __RTC_H */
/*****************************************************************************
 **                            End Of File
 ******************************************************************************/
