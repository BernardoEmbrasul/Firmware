...
uint32_t portaMapped[NUM_PINOS][3]={  //pino, porta, pino,porta
 				{ 1<<15,0, WDI_Pin      }, //BACKLIGHT_Pin
				{ 1<<0 , 0, TCL3_Pin    },
				{ 1<<1 , 0, TCL4_Pin  },
				{ 1<<10, 0, TCL5_Pin  },
				{ 1<<11, 0, TCL6_Pin  },
				{ 1<<20, 0,  AUXOUT1_Pin},    ///RS_Pin
				...
				{ 1<<0,  2, DPY0_Pin  },
			     { 0x00800000,  0, ADC1P_Pin  }, //{ 1<<1,  2, DPY1_Pin  },
				 { 0x01000000,  0, ADC2P_Pin  }, // { 1<<2,  2, DPY2_Pin  },
				 { 0x02000000,  0, ADC3P_Pin  }, //{ 1<<3,  2, DPY3_Pin  },
				 { 0x04000000,  0, ADC4P_Pin  }, // { 1<<4,  2, DPY4_Pin  },
				 { 0x40000000,  1, ADC5P_Pin },  //{ 1<<5,  2, DPY5_Pin  },
				 { 0x80000000,  1, ADC6P_Pin  }, //{ 1<<6,  2, DPY6_Pin  },
				 { 1<<7,  2, DPY7_Pin  }
		};
 ...
 GPIO_TypeDef *portaST[NUM_PINOS][1]={  //pino, porta, pino,porta
		...
		{  PWD_GPIO_Port  },
  		{  WDI_GPIO_Port  },
  		{  DPY0_GPIO_Port },
		{  ADC1P_GPIO_Port},  //{   DPY1_GPIO_Port },
  		{  ADC2P_GPIO_Port},  //{  DPY2_GPIO_Port },
  		{  ADC3P_GPIO_Port},  //{  DPY3_GPIO_Port },
  		{  ADC4P_GPIO_Port},  //{  DPY4_GPIO_Port },
  		{  ADC5P_GPIO_Port},  //{  DPY5_GPIO_Port },
  		{  ADC6P_GPIO_Port},  //{  DPY6_GPIO_Port },
		{  DPY7_GPIO_Port }
