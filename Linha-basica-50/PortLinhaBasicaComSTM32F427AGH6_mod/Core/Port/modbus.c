		...
		case FUNCAO_SLAVE_ID:
			{
...
#if EQUIP==MD_EQUIP
				UART0Buffer[index_out]=0x49;    //ID=0x49 = MD50
				OldCrc=CalcCRC(OldCrc,UART0Buffer[index_out]); index_out++;
...
#endif
#if EQUIP==CA_EQUIP
				UART0Buffer[index_out]=0x50;    //ID=0x50
				OldCrc=CalcCRC(OldCrc,UART0Buffer[index_out]); index_out++;
				...
				OldCrc=CalcCRC(OldCrc,UART0Buffer[index_out]); index_out++;
				UART0Buffer[index_out]='A';
#endif
#if EQUIP==CP_EQUIP
				UART0Buffer[index_out]=0x51;    //ID=0x51
				OldCrc=CalcCRC(OldCrc,UART0Buffer[index_out]); index_out++;
...
#endif
#if EQUIP==CD_EQUIP
				UART0Buffer[index_out]=0x52;    //ID=0x52
				OldCrc=CalcCRC(OldCrc,UART0Buffer[index_out]); index_out++;
...
#endif
#if EQUIP==CT_EQUIP
				UART0Buffer[index_out]=0x53;    //ID=0x52
				OldCrc=CalcCRC(OldCrc,UART0Buffer[index_out]); index_out++;
...
/*
				...
				if ((unsigned)(EnderecoInicial.i+NumeroDeRegistros.c[LOW])>1800){
					ExceptionCodeMODBUS=ILLEGAL_DATA_ADDRESS;
				}
...
#define FLASH_PAG7									 67	 */
				...
				if (modo_escritaMM==0){
				...
				#endif
					{
						...
						if (((unsigned short)NroPorta2==0xFFFF)||(( short)NroPorta2==-1)||(( short)NroPorta2<0)||(( short)NroPorta2==0))
						{
							NroPorta2=NroPorta;
						}
				...
				//ao alterar o rel�gio, tudo o conte�do da MM e batram � apagado!
							/*
							 * este trecho foi comentado, pois aparentemente o sp4000 e o serviço do power tratan duplicidade de horarios
							 * não sendo mais necessario apagar toda a flash
							toogleWDI();
							ClearBatteryRam();
							...
							toogleWDI();
							erase((void*)SETOR_MM_INICIO,(void*)0x080BFFFF);
							toogleWDI();
							erase((void*)0x080C0000,(void*)0x080DFFFF);
							toogleWDI();
							erase((void*)0x080E0000,(void*)0x080FFFFF);
							toogleWDI();
							*/
					 }
