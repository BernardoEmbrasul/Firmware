...
extern DWORD PHYInit1( DWORD PHYType );
...
void send_data(short Length);

DWORD EMACInit2( void );
DWORD EMACInit1( void );
DWORD EMACInit0( void );
void eth_admite_nested_interrupt_srv(void);
extern void eth_admite_nested_interrupt_irq(void);
void processar_arp(void);
void uip_process(void);
unsigned short ip_sum_calc(unsigned short len_ip_header, BYTE buff[]);
